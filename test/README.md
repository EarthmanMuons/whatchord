...
Engine and formatter tests live with the engine in
`packages/whatchord_theory/test/` (see its README) and run via `dart test` from
that package. The `theory/` directory here holds only the app-side theory tests
