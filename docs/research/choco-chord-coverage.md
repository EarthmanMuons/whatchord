...
[`tool/choco_chord_label_stats.py`](../../tool/choco_chord_label_stats.py).

The command used for this snapshot was:

```sh
python3 tool/choco_chord_label_stats.py /private/tmp/choco --jams-version converted --top 50
```
